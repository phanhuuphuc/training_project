        ...
        <div className="min-h-screen bg-gray-100">
            <nav className="bg-white border-b border-gray-100">
                <div className="space-y-6 div-main">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="shrink-0 flex items-center p-5">
                                <Link href="/">
                                    <img src="/image/logo.png" alt="" className="block fill-current text-gray-800 logo-auth"  />
                                </Link>
                            </div>
            ...
            {header && (
                <header className="bg-white shadow">
                    <div className="space-y-6 div-main px-7 py-3">{header}</div>
                </header>
            )}
